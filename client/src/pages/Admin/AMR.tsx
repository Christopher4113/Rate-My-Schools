...
const AMR = () => {
  ...
  const fetchReviews = () => {
    axios
      .get(`http://localhost:8080/auth/getMajorsReview/${id}`)
  ...
  const handleDelete = (reviewId: number) => {
    axios
      .delete(`http://localhost:8080/auth/deleteMajorsReview/${reviewId}`)
      .then(() => {
  ...
  return (
    <div className="p-6">
      <h1 className="text-2xl font-bold mb-4">Major Reviews</h1>
      {reviews.length === 0 ? (
