...
const MajorsReview = () => {
  ...
  useEffect(() => {
    axios.get<Form[]>(`http://localhost:8080/auth/getMajorsReview/${id}`)
      .then((response) => {
  ...
  useEffect(() => {
    axios.get(`http://localhost:8080/auth/getMajorsAverageRating/${id}`)
      .then(response => {
  ...
  useEffect(() => {
    axios.get(`http://localhost:8080/auth/getMajorsTotalReviews/${id}`)
      .then(response => {
        const data = response.data;
  ...
  useEffect(() => {
    axios.get(`http://localhost:8080/auth/getMajorsName/${id}`)
         .then(response => {
          const data = response.data;
  ...
  const handleSubmit = async(e:React.FormEvent) => {
    ...
    try {
      await axios.post("http://localhost:8080/auth/postMajorsReview", {
        major: { id: Number(id) },
        rating,
        review: reviewText,
      ...
      const reviewResponse = await axios.get<Form[]>(`http://localhost:8080/auth/getMajorsReview/${id}`);
      ...
      const avgResponse = await axios.get(`http://localhost:8080/auth/getMajorsAverageRating/${id}`);
      setAverageRating(avgResponse.data.averageRating);
      
      const totalResponse = await axios.get(`http://localhost:8080/auth/getMajorsTotalReviews/${id}`);
